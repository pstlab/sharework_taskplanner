DOMAIN KNOWLEDGE_PRODUCTION_AUTHORING_GEN {
	...
	COMPONENT ProductionL3 {FLEXIBLE tasks_l3(functional)} : ProductionHierarchyL3Type;
	COMPONENT ProductionL4 {FLEXIBLE tasks_l4(functional)} : ProductionHierarchyL4Type;
