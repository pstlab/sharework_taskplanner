DOMAIN ICAPS21_HRC_MOSAIC_R3_C2_B6W0O0  {
	...
	COMP_TYPE SingletonStateVariable AssemblyProcessType ( DoR1C1(),  DoR1C2(),  DoR2C1(),  DoR2C2(),  DoR3C1(),  DoR3C2(),  Idle() ) {
	...
	COMP_TYPE SingletonStateVariable HumanAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R3C1(),  _pickplace-R3C2(),  Idle() ) {
	...
	COMP_TYPE SingletonStateVariable RobotAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R3C1(),  _pickplace-R3C2(),  Idle() ) {
