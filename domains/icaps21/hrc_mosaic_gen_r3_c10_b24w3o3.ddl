DOMAIN ICAPS21_HRC_MOSAIC_R3_C10_B24W3O3  {
	...
	COMP_TYPE SingletonStateVariable AssemblyProcessType ( DoR1C1(),  DoR1C2(),  DoR1C3(),  DoR1C4(),  DoR1C5(),  DoR1C6(),  DoR1C7(),  DoR1C8(),  DoR1C9(),  DoR1C10(),  DoR2C1(),  DoR2C2(),  DoR2C3(),  DoR2C4(),  DoR2C5(),  DoR2C6(),  DoR2C7(),  DoR2C8(),  DoR2C9(),  DoR2C10(),  DoR3C1(),  DoR3C2(),  DoR3C3(),  DoR3C4(),  DoR3C5(),  DoR3C6(),  DoR3C7(),  DoR3C8(),  DoR3C9(),  DoR3C10(),  Idle() ) {
	...
	COMP_TYPE SingletonStateVariable HumanAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R1C6(),  _pickplace-R1C7(),  _pickplace-R1C8(),  _pickplace-R1C9(),  _pickplace-R1C10(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R2C6(),  _pickplace-R2C7(),  _pickplace-R2C8(),  _pickplace-R2C9(),  _pickplace-R2C10(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R3C6(),  _pickplace-R3C7(),  _pickplace-R3C8(),  _pickplace-R3C9(),  _pickplace-R3C10(),  Idle() ) {
		...
		VALUE _pickplace-R1C2() [30, 40]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C3() [26, 36]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R1C7() [32, 42]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C8() [1, 8]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C9() [24, 34]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C10() [3, 13]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R2C2() [30, 40]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C3() [30, 40]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R2C9() [5, 15]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C10() [33, 43]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C1() [28, 38]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R3C4() [17, 27]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C5() [20, 30]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R3C8() [26, 36]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C9() [1, 10]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C10() [22, 32]
		MEETS {
			Idle();
	...
	COMP_TYPE SingletonStateVariable RobotAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R1C6(),  _pickplace-R1C7(),  _pickplace-R1C8(),  _pickplace-R1C9(),  _pickplace-R1C10(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R2C6(),  _pickplace-R2C7(),  _pickplace-R2C8(),  _pickplace-R2C9(),  _pickplace-R2C10(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R3C6(),  _pickplace-R3C7(),  _pickplace-R3C8(),  _pickplace-R3C9(),  _pickplace-R3C10(),  Idle() ) {
		...
		VALUE _pickplace-R1C7() [15, 25]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C8() [13, 23]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C9() [9, 19]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C10() [1, 6]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R3C7() [14, 24]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C8() [4, 14]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C9() [6, 16]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C10() [1, 8]
		MEETS {
			Idle();
