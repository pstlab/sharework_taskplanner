DOMAIN ICAPS21_HRC_MOSAIC_R5_C6_B24W3O3  {
	...
	COMP_TYPE SingletonStateVariable AssemblyProcessType ( DoR1C1(),  DoR1C2(),  DoR1C3(),  DoR1C4(),  DoR1C5(),  DoR1C6(),  DoR2C1(),  DoR2C2(),  DoR2C3(),  DoR2C4(),  DoR2C5(),  DoR2C6(),  DoR3C1(),  DoR3C2(),  DoR3C3(),  DoR3C4(),  DoR3C5(),  DoR3C6(),  DoR4C1(),  DoR4C2(),  DoR4C3(),  DoR4C4(),  DoR4C5(),  DoR4C6(),  DoR5C1(),  DoR5C2(),  DoR5C3(),  DoR5C4(),  DoR5C5(),  DoR5C6(),  Idle() ) {
	...
	COMP_TYPE SingletonStateVariable HumanAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R1C6(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R2C6(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R3C6(),  _pickplace-R4C1(),  _pickplace-R4C2(),  _pickplace-R4C3(),  _pickplace-R4C4(),  _pickplace-R4C5(),  _pickplace-R4C6(),  _pickplace-R5C1(),  _pickplace-R5C2(),  _pickplace-R5C3(),  _pickplace-R5C4(),  _pickplace-R5C5(),  _pickplace-R5C6(),  Idle() ) {
		...
		VALUE _pickplace-R2C4() [2, 12]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C5() [6, 16]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C6() [29, 39]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R3C6() [7, 17]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C1() [36, 46]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C2() [1, 7]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R4C6() [18, 28]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C1() [36, 46]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R5C3() [1, 11]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C4() [35, 45]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C5() [20, 30]
		MEETS {
			Idle();
	...
	COMP_TYPE SingletonStateVariable RobotAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R1C6(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R2C6(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R3C6(),  _pickplace-R4C1(),  _pickplace-R4C2(),  _pickplace-R4C3(),  _pickplace-R4C4(),  _pickplace-R4C5(),  _pickplace-R4C6(),  _pickplace-R5C1(),  _pickplace-R5C2(),  _pickplace-R5C3(),  _pickplace-R5C4(),  _pickplace-R5C5(),  _pickplace-R5C6(),  Idle() ) {
		...
		VALUE _pickplace-R1C6() [5, 15]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C1() [13, 23]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R3C6() [14, 24]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C1() [7, 17]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C2() [11, 21]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C3() [7, 17]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R5C4() [12, 22]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C5() [14, 24]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C6() [6, 16]
		MEETS {
			Idle();
