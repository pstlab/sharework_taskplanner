DOMAIN ICAPS21_HRC_MOSAIC_R6_C5_B24W3O3  {
	...
	COMP_TYPE SingletonStateVariable AssemblyProcessType ( DoR1C1(),  DoR1C2(),  DoR1C3(),  DoR1C4(),  DoR1C5(),  DoR2C1(),  DoR2C2(),  DoR2C3(),  DoR2C4(),  DoR2C5(),  DoR3C1(),  DoR3C2(),  DoR3C3(),  DoR3C4(),  DoR3C5(),  DoR4C1(),  DoR4C2(),  DoR4C3(),  DoR4C4(),  DoR4C5(),  DoR5C1(),  DoR5C2(),  DoR5C3(),  DoR5C4(),  DoR5C5(),  DoR6C1(),  DoR6C2(),  DoR6C3(),  DoR6C4(),  DoR6C5(),  Idle() ) {
	...
	COMP_TYPE SingletonStateVariable HumanAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R4C1(),  _pickplace-R4C2(),  _pickplace-R4C3(),  _pickplace-R4C4(),  _pickplace-R4C5(),  _pickplace-R5C1(),  _pickplace-R5C2(),  _pickplace-R5C3(),  _pickplace-R5C4(),  _pickplace-R5C5(),  _pickplace-R6C1(),  _pickplace-R6C2(),  _pickplace-R6C3(),  _pickplace-R6C4(),  _pickplace-R6C5(),  Idle() ) {
		...
		VALUE _pickplace-R3C4() [26, 36]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C5() [31, 41]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R4C2() [9, 19]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C3() [5, 15]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C4() [25, 35]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C5() [1, 11]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C1() [34, 44]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C2() [34, 44]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C3() [29, 39]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R6C1() [9, 19]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R6C2() [10, 20]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R6C3() [11, 21]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R6C4() [23, 33]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R6C5() [19, 29]
		MEETS {
			Idle();
	...
	COMP_TYPE SingletonStateVariable RobotAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R4C1(),  _pickplace-R4C2(),  _pickplace-R4C3(),  _pickplace-R4C4(),  _pickplace-R4C5(),  _pickplace-R5C1(),  _pickplace-R5C2(),  _pickplace-R5C3(),  _pickplace-R5C4(),  _pickplace-R5C5(),  _pickplace-R6C1(),  _pickplace-R6C2(),  _pickplace-R6C3(),  _pickplace-R6C4(),  _pickplace-R6C5(),  Idle() ) {
		...
		VALUE _pickplace-R1C4() [5, 15]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C5() [5, 15]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R5C5() [10, 20]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R6C1() [1, 6]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R6C2() [4, 14]
		MEETS {
			Idle();
