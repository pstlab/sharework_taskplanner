DOMAIN ICAPS21_HRC_MOSAIC_R5_C7_B29W3O3  {
	...
	COMP_TYPE SingletonStateVariable HumanAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R1C6(),  _pickplace-R1C7(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R2C6(),  _pickplace-R2C7(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R3C6(),  _pickplace-R3C7(),  _pickplace-R4C1(),  _pickplace-R4C2(),  _pickplace-R4C3(),  _pickplace-R4C4(),  _pickplace-R4C5(),  _pickplace-R4C6(),  _pickplace-R4C7(),  _pickplace-R5C1(),  _pickplace-R5C2(),  _pickplace-R5C3(),  _pickplace-R5C4(),  _pickplace-R5C5(),  _pickplace-R5C6(),  _pickplace-R5C7(),  Idle() ) {
		...
		VALUE _pickplace-R1C3() [27, 37]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C4() [29, 39]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R2C6() [14, 24]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C7() [1, 6]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R3C4() [6, 16]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C5() [36, 46]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R4C3() [35, 45]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C4() [23, 33]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R4C6() [28, 38]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C7() [6, 16]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C1() [31, 41]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C2() [21, 31]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C3() [1, 8]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R5C5() [30, 40]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C6() [7, 17]
		MEETS {
			Idle();
	...
	COMP_TYPE SingletonStateVariable RobotAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R1C6(),  _pickplace-R1C7(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R2C6(),  _pickplace-R2C7(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R3C6(),  _pickplace-R3C7(),  _pickplace-R4C1(),  _pickplace-R4C2(),  _pickplace-R4C3(),  _pickplace-R4C4(),  _pickplace-R4C5(),  _pickplace-R4C6(),  _pickplace-R4C7(),  _pickplace-R5C1(),  _pickplace-R5C2(),  _pickplace-R5C3(),  _pickplace-R5C4(),  _pickplace-R5C5(),  _pickplace-R5C6(),  _pickplace-R5C7(),  Idle() ) {
		...
		VALUE _pickplace-R1C6() [16, 26]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C7() [1, 11]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R3C7() [4, 14]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C1() [13, 23]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C2() [3, 13]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C3() [12, 22]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R4C5() [3, 13]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C6() [10, 20]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C7() [11, 21]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C1() [1, 5]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R5C3() [11, 21]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C4() [1, 5]
		MEETS {
			Idle();
