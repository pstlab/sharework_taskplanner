DOMAIN ICAPS21_HRC_MOSAIC_R5_C10_B40W5O5  {
	...
	COMP_TYPE SingletonStateVariable AssemblyProcessType ( DoR1C1(),  DoR1C2(),  DoR1C3(),  DoR1C4(),  DoR1C5(),  DoR1C6(),  DoR1C7(),  DoR1C8(),  DoR1C9(),  DoR1C10(),  DoR2C1(),  DoR2C2(),  DoR2C3(),  DoR2C4(),  DoR2C5(),  DoR2C6(),  DoR2C7(),  DoR2C8(),  DoR2C9(),  DoR2C10(),  DoR3C1(),  DoR3C2(),  DoR3C3(),  DoR3C4(),  DoR3C5(),  DoR3C6(),  DoR3C7(),  DoR3C8(),  DoR3C9(),  DoR3C10(),  DoR4C1(),  DoR4C2(),  DoR4C3(),  DoR4C4(),  DoR4C5(),  DoR4C6(),  DoR4C7(),  DoR4C8(),  DoR4C9(),  DoR4C10(),  DoR5C1(),  DoR5C2(),  DoR5C3(),  DoR5C4(),  DoR5C5(),  DoR5C6(),  DoR5C7(),  DoR5C8(),  DoR5C9(),  DoR5C10(),  Idle() ) {
	...
	COMP_TYPE SingletonStateVariable HumanAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R1C6(),  _pickplace-R1C7(),  _pickplace-R1C8(),  _pickplace-R1C9(),  _pickplace-R1C10(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R2C6(),  _pickplace-R2C7(),  _pickplace-R2C8(),  _pickplace-R2C9(),  _pickplace-R2C10(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R3C6(),  _pickplace-R3C7(),  _pickplace-R3C8(),  _pickplace-R3C9(),  _pickplace-R3C10(),  _pickplace-R4C1(),  _pickplace-R4C2(),  _pickplace-R4C3(),  _pickplace-R4C4(),  _pickplace-R4C5(),  _pickplace-R4C6(),  _pickplace-R4C7(),  _pickplace-R4C8(),  _pickplace-R4C9(),  _pickplace-R4C10(),  _pickplace-R5C1(),  _pickplace-R5C2(),  _pickplace-R5C3(),  _pickplace-R5C4(),  _pickplace-R5C5(),  _pickplace-R5C6(),  _pickplace-R5C7(),  _pickplace-R5C8(),  _pickplace-R5C9(),  _pickplace-R5C10(),  Idle() ) {
		...
		VALUE _pickplace-R1C3() [30, 40]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C4() [1, 8]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C5() [19, 29]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C6() [10, 20]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R1C8() [5, 15]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C9() [36, 46]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C10() [9, 19]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R2C5() [31, 41]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C6() [30, 40]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R2C8() [27, 37]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C9() [1, 6]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C10() [3, 13]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R3C3() [35, 45]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C4() [1, 8]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C5() [29, 39]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C6() [24, 34]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C7() [1, 9]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C8() [32, 42]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C9() [21, 31]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C10() [5, 15]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R4C2() [18, 28]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C3() [36, 46]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C4() [12, 22]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C5() [30, 40]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R4C9() [29, 39]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C10() [36, 46]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C1() [9, 19]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C2() [33, 43]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R5C4() [14, 24]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C5() [23, 33]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C6() [32, 42]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C7() [19, 29]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C8() [34, 44]
		MEETS {
			Idle();
	...
	COMP_TYPE SingletonStateVariable RobotAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R1C6(),  _pickplace-R1C7(),  _pickplace-R1C8(),  _pickplace-R1C9(),  _pickplace-R1C10(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R2C6(),  _pickplace-R2C7(),  _pickplace-R2C8(),  _pickplace-R2C9(),  _pickplace-R2C10(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R3C6(),  _pickplace-R3C7(),  _pickplace-R3C8(),  _pickplace-R3C9(),  _pickplace-R3C10(),  _pickplace-R4C1(),  _pickplace-R4C2(),  _pickplace-R4C3(),  _pickplace-R4C4(),  _pickplace-R4C5(),  _pickplace-R4C6(),  _pickplace-R4C7(),  _pickplace-R4C8(),  _pickplace-R4C9(),  _pickplace-R4C10(),  _pickplace-R5C1(),  _pickplace-R5C2(),  _pickplace-R5C3(),  _pickplace-R5C4(),  _pickplace-R5C5(),  _pickplace-R5C6(),  _pickplace-R5C7(),  _pickplace-R5C8(),  _pickplace-R5C9(),  _pickplace-R5C10(),  Idle() ) {
		...
		VALUE _pickplace-R1C8() [7, 17]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C9() [1, 5]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R1C10() [17, 27]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R2C9() [14, 24]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C10() [8, 18]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R3C5() [17, 27]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C6() [1, 11]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C7() [3, 13]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R4C5() [14, 24]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C6() [6, 16]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C7() [7, 17]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R5C6() [1, 8]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C7() [4, 14]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R5C9() [13, 23]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R5C10() [8, 18]
		MEETS {
			Idle();
	...
	SYNCHRONIZE Mosaic.process {
		...
		VALUE DoR5() {
			...
			d9 Assembly.coordination.DoR5C10();
			CONTAINS [0, +INF] [0, +INF] d9;
	...
	SYNCHRONIZE Assembly.coordination {
		...
		VALUE DoR5C10() {
			...
			d0 Robot.task._pickplace-R5C10();
			CONTAINS [0, +INF] [0, +INF] d0;
		...
		VALUE DoR5C10() {
			...
			d0 Human.operation._pickplace-R5C10();
			CONTAINS [0, +INF] [0, +INF] d0;
