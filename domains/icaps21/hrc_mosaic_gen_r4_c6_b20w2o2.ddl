DOMAIN ICAPS21_HRC_MOSAIC_R4_C6_B20W2O2  {
	...
	COMP_TYPE SingletonStateVariable AssemblyProcessType ( DoR1C1(),  DoR1C2(),  DoR1C3(),  DoR1C4(),  DoR1C5(),  DoR1C6(),  DoR2C1(),  DoR2C2(),  DoR2C3(),  DoR2C4(),  DoR2C5(),  DoR2C6(),  DoR3C1(),  DoR3C2(),  DoR3C3(),  DoR3C4(),  DoR3C5(),  DoR3C6(),  DoR4C1(),  DoR4C2(),  DoR4C3(),  DoR4C4(),  DoR4C5(),  DoR4C6(),  Idle() ) {
	...
	COMP_TYPE SingletonStateVariable HumanAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R1C6(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R2C6(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R3C6(),  _pickplace-R4C1(),  _pickplace-R4C2(),  _pickplace-R4C3(),  _pickplace-R4C4(),  _pickplace-R4C5(),  _pickplace-R4C6(),  Idle() ) {
		...
		VALUE _pickplace-R2C4() [6, 16]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R2C5() [1, 6]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R3C2() [25, 35]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R3C3() [3, 13]
		MEETS {
			Idle();
		...
		VALUE _pickplace-R4C4() [3, 13]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C5() [24, 34]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C6() [23, 33]
		MEETS {
			Idle();
	...
	COMP_TYPE SingletonStateVariable RobotAgentType ( _pickplace-R1C1(),  _pickplace-R1C2(),  _pickplace-R1C3(),  _pickplace-R1C4(),  _pickplace-R1C5(),  _pickplace-R1C6(),  _pickplace-R2C1(),  _pickplace-R2C2(),  _pickplace-R2C3(),  _pickplace-R2C4(),  _pickplace-R2C5(),  _pickplace-R2C6(),  _pickplace-R3C1(),  _pickplace-R3C2(),  _pickplace-R3C3(),  _pickplace-R3C4(),  _pickplace-R3C5(),  _pickplace-R3C6(),  _pickplace-R4C1(),  _pickplace-R4C2(),  _pickplace-R4C3(),  _pickplace-R4C4(),  _pickplace-R4C5(),  _pickplace-R4C6(),  Idle() ) {
		...
		VALUE _pickplace-R4C3() [1, 11]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C4() [11, 21]
		MEETS {
			Idle();

		}

		VALUE _pickplace-R4C5() [15, 25]
		MEETS {
			Idle();
