package com.github.sharework_taskplanner.taskplanner.acting;
...
public class ActingNode extends AbstractNodeMain
{
     ...
     */
    public ActingNode() {
        this.nodeName = "/sharework/taskplanner";
    }
    ...
    public void onStart(ConnectedNode connectedNode)
    {
        ...
        // create configuration service handler
        connectedNode.newServiceServer(
                "/sharework/taskplanner/configuration",
                roxanne_rosjava_msgs.ActingConfigurationService._TYPE,
                new ServiceResponseBuilder<roxanne_rosjava_msgs.ActingConfigurationServiceRequest, roxanne_rosjava_msgs.ActingConfigurationServiceResponse>() {
