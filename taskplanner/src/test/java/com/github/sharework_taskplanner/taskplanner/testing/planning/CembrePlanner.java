...
public class CembrePlanner extends Planner
{
	protected CembrePlanner() {
		super();
	}
	...
	{ 
		try 
		{
			...
			String[] model = new String[] {
					"domains/sharework/cembre/hrc_cembre.ddl",
					"domains/sharework/cembre/hrc_cembre.pdl"
			};
