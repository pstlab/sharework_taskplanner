...
import com.github.sharework_taskplanner.taskplanner.heuristics.search.icaps21.Icaps21DBS;
...
@SearchStrategyConfiguration(
		strategy = Icaps21DBS.class
)
@FrameworkLoggerConfiguration(		
		level = FrameworkLoggingLevel.OFF
)
public class DBSPlanner extends Planner 
{
	protected DBSPlanner() {
		super();
	}
