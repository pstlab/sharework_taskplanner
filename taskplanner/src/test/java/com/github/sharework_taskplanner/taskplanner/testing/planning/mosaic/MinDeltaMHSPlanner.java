package com.github.sharework_taskplanner.taskplanner.testing.planning.mosaic;
...
public class MinDeltaMHSPlanner extends Planner 
{
	protected MinDeltaMHSPlanner() {
		super();
	}
