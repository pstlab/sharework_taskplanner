...
import com.github.sharework_taskplanner.taskplanner.heuristics.search.icaps21.THS;
...
public class THSPlanner extends Planner
{
	protected THSPlanner() {
		super();
	}
