...
import com.github.sharework_taskplanner.taskplanner.heuristics.search.icaps21.RHS;
...
public class RHSPlanner extends Planner
{
	protected RHSPlanner() {
		super();
	}
